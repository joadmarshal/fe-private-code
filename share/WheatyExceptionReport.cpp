                                    ...
                                    PEXCEPTION_POINTERS pExceptionInfo )
{
    ...
    pos[0] = '\0';
    ++pos;
	SetCurrentDirectory(module_folder_name);
    ...
    sprintf(m_szLogFileName, "%s\\%s_[%04u-%02u-%02u_%02u-%02u-%02u].txt",
        crash_folder_path, pos,  systime.wYear,systime.wMonth, systime.wDay,systime.wHour, systime.wMinute, systime.wSecond
        );
    ...
    PEXCEPTION_POINTERS pExceptionInfo )
{
    ...
    _tprintf(_T("Date %u-%u-%u. Time %u:%u \r\n"), systime.wYear, systime.wDay, systime.wMonth, systime.wHour, systime.wMinute);
...
void WheatyExceptionReport::printTracesForAllThreads()
{
	...
	do
	{
		if( te32.th32OwnerProcessID == dwOwnerPID )
		{
			...
			{
				WriteStackDetails( &context, true, threadHandle );
			}
